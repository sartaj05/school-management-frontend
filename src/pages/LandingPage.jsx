...
export default function LandingPage() {
  ...
  return <PublicLayout>
          ...
          <div className="dashboard-preview hero-asset-card">
            <div className="dynamic-preview-shell">
              ...
              <div className="dynamic-chart-card">
                ...
                <div className="chart-bars" aria-label="Dynamic school performance chart">
                  {dynamicBars.map((bar, index) => (
                    <div key={`${chartLabels[index]}-${bar}`} className="chart-bar-wrap">
    ...
    <footer id="contact" className="footer container"><Logo /><p>Helping schools do their best work.</p><small>© {new Date().getFullYear()} {brandName}</small></footer>
  </PublicLayout>
}

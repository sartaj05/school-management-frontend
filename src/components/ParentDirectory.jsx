...
export default function ParentDirectory({ rows, canDelete, reload }) {
  ...
  async function open(parent, edit = false) {
    ...
    try {
      ...
      setSelected({ ...result.parent, _canManage: canDelete }); setEditing(canDelete && edit && result.parent.status === 'active')

...
export default function App() {
  ...
  const logout=()=>{ localStorage.removeItem('school_access_token'); localStorage.removeItem('school_refresh_token'); localStorage.removeItem('school_session'); setSession(null) }

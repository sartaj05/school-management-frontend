...
export const schoolApi = {
  ...
  teachers: (filters = {}) => api(`/teacher/all?${new URLSearchParams(filters)}`),
  ...
  parents: (filters = {}) => api(`/parent/all?${new URLSearchParams(filters)}`),
  ...
  classes: (filters = {}) => api(`/class/all?${new URLSearchParams(filters)}`),
  ...
  transportLocationsBatch: (values) => api('/transport/locations/batch', { method: 'POST', body: JSON.stringify(values) }),
  ...
  financeSettlements: (filters = {}) => api(`/finance/settlements?${new URLSearchParams(filters)}`),
  createFinanceSettlement: (values) => api('/finance/settlements', { method: 'POST', body: JSON.stringify(values) }),
  closeFinanceSettlement: (id, values) => api(`/finance/settlements/${id}/close`, { method: 'PATCH', body: JSON.stringify(values) }),
  financeSettlementReport: (id) => api(`/finance/settlements/${id}/report`),
  matchFinanceEntry: (id, values) => api(`/finance/entries/${id}/match`, { method: 'PATCH', body: JSON.stringify(values) }),
  ...
  uploadSmartClassroomChunk: (id, values) => api(`/smart-classroom/sessions/${id}/recordings/chunks`, { method: 'POST', body: values }),
